...
void Test_Map() {
	...
	SLank.insert(std::make_pair(One_Char(3, "�ǹ���"), "�����ϻ��"));
	SLank.insert(std::make_pair(One_Char(1, "�����Ʈ"), "����"));
	SLank.insert(std::make_pair(One_Char(7, "ŷ"), "ŷ�ν���"));
	SLank.insert(std::make_pair(One_Char(4, "����� �繫����"), "�˼�"));
	SLank.insert(std::make_pair(One_Char(2, "Ÿ����Ű"), "������"));
	SLank.insert(std::make_pair(One_Char(2, "Ÿ����Ű"), "������"));


	Print_Map(SLank);

	SLank.erase(One_Char(3, "�ǹ���"));
	SLank.erase(SLank.begin());
	SLank.insert(
		std::pair<One_Char,std::string>(One_Char(0, "����Ÿ��"), "���ɽø���"));
	Print_Map(SLank);
...
void Test_optional() {
	...
	case Option_Kind::option_value: {
		...
		std::cout << "�� 2�� �ش��ϴ� ����? = " << fn(m, 2).value().c_str() << std::endl;
		std::cout << "�� 4�� �ش��ϴ� �����ֳ���? = " << std::boolalpha
	...
	case Option_Kind::option_create: {
		Basic bs;
		std::cout << "option ��ü ����---------------" << std::endl;
		std::optional<Basic> ob;
		std::cout << "���� ������ ob ȣ��" << std::endl;
		ob = bs;
		break;
	}
