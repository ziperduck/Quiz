...
void Mock_Test() {
	...
	//chul_su 0��, Young_Hee 1��, Min_Ji 2��
...
void RecommendNewId()
{
	...
	/*
O	1�ܰ� new_id�� ��� �빮�ڸ� �����Ǵ� �ҹ��ڷ� ġȯ�մϴ�.
O	2�ܰ� new_id���� ���ĺ� �ҹ���, ����, ����(-), ����(_), ��ħǥ(.)�� ������ ��� ���ڸ� �����մϴ�.
O	3�ܰ� new_id���� ��ħǥ(.)�� 2�� �̻� ���ӵ� �κ��� �ϳ��� ��ħǥ(.)�� ġȯ�մϴ�.
O	4�ܰ� new_id���� ��ħǥ(.)�� ó���̳� ���� ��ġ�Ѵٸ� �����մϴ�.
...
void find_kim() {
	...
	for (int i = 0; i < seoul.size(); i++)
	{
		if (seoul.at(i) == "Kim")
		{
			answer = "�輭�� " + std::to_string(i) + "�� �ִ�";
			break;
		}
	}
	//distance�� iterator�� ���̸� ��Ʈ������ ��ȯ�Ѵ�.
	int num = std::distance(seoul.begin(),std::find(seoul.begin(), seoul.end(), "Kim"));
	answer = "�輭�� " + std::to_string(num) + "�� �ִ�";
